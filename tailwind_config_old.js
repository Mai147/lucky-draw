    ...
    theme: {
        extend: {
            backgroundImage: {
                ...
                "skin-tet":
                    "linear-gradient(to bottom right, var(--color-bg-from-tet), var(--color-bg-to-tet)), url('../public/images/tet2026.png')",
            },
            backgroundColor: {
                ...
                "input-tet": "var(--color-input-background-tet)",
                "box-tet": "var(--color-box-bg-tet)",
                "box-inner-tet": "var(--color-box-border-inner-tet)",
                "box-outter-tet": "var(--color-box-border-outter-tet)",
                "button-hover-tet":
                    "var(--color-button-background-hover-tet)",
                "button-tet": "var(--color-button-background-tet)",
            },
            textColor: {
                ...
                "header-icon-tet": "var(--color-header-icon-tet)",
                "header-tet": "var(--color-header-text-tet)",
                "skin-tet": "var(--color-text-tet)",
                "input-tet": "var(--color-input-text-tet)",
                "box-tet": "var(--color-box-text-tet)",
            },
            borderColor: {
                ...
                "box-inner-chessmaze": "var(--color-box-border-inner-chessmaze)",
                "box-outter-chessmaze": "var(--color-box-border-outter-chessmaze)",
                "input-tet": "var(--color-input-border-tet)",
                "box-inner-tet": "var(--color-box-border-inner-tet)",
                "box-outter-tet": "var(--color-box-border-outter-tet)",
            },
        },
